...
public class OrderService {
    ...
    public String placeOrder(OrderRequest orderRequest) {
        ...
        // System.out.println("List<String> skuCode = " + skuCode);


        //Call inventory service. Place order if inventory is in stock..
        ...
        if(allProductsAreInStock){
            ...
            OrderPlacedEvent event = OrderPlacedEvent.builder().orderNumber(order.getOrderNumber()).build();
